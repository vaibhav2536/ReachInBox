      ...
      <div className="bg-black text-white w-screen h-screen flex flex-col justify-center items-center">
        <div className="bg-[#111214] text-center space-y-10 px-16 rounded-2xl border border-[#343A40]">
          <div className="">
            ...
            <div
              className="mt-6 border-white/40 border px-20 py-2 text-sm flex items-center text-[#CCCCCC] rounded-lg"
              // style={{ cursor: 'not-allowed' }} // Disable the pointer events
            >
          ...
          <div className="">
            <div
              className="bg-gradient-to-r from-[#4B63DD] to-[#0524BFFC] mx-16 mt-5 px-6 text-sm py-3 rounded-md"
              // style={{ cursor: 'not-allowed' }} // Disable the pointer events
            >
              Create an Account
            </div>
            <div className="my-8 mb-10 text-[#909296]">
              ...
              <span onClick={handleGoogleLogin} className="text-[#C1C2C5] cursor-pointer">
                Sign In
              </span>
            </div>
          </div>
