...
function Mail({
  ...
  return (
    <div
      className="border-t dark:border-[#ffffff25] border-[#8b8b8b64] mx-8 py-4 cursor-pointer"
      onClick={handleMailClick}
    >
      <div>
        <div className="flex justify-between items-center">
          <div className="flex-1 dark:text-white text-black text-base font-normal">
            {fromEmail}
          </div>
          <div className="ml-6 dark:text-[#FCFCFC66] text-[#919EAB] font-thin whitespace-nowrap">
            Mar 7
          </div>
        </div>
        <div className="py-1 dark:text-[#E1E0E0] text-gray-600 font-normal">
          {trimSubject(subject, 7)}
        </div>
        <div className="flex gap-2 mt-2">
          <div className="dark:bg-[#222426] bg-[#F0F0F0] px-2 py-0.5 rounded-2xl text-[#57E0A6] text-sm flex items-center">
            <GoDotFill className="mr-1 text-lg" />
            Interested
          </div>
          <div className="dark:bg-[#222426] bg-[#F0F0F0] px-2 py-0.5 rounded-2xl dark:text-white text-black text-sm flex items-center">
